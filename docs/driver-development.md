...
* [`application.yml`](https://github.com/decentralized-identity/universal-resolver/blob/main/uni-resolver-web/src/main/resources/application.yml) (add your driver)
  * id - stable, unique identifier for this resolver driver entry. This is used for operational controls such as runtime entry disabling, and should not be changed casually once published.
