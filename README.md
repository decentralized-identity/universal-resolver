...
You should then be able to resolve identifiers locally using simple `curl` requests as follows:
	...
	curl -X GET http://localhost:8080/1.0/identifiers/did:kscirc:k17bdBuzB3u143mFXZNq3jRHNgMgdFTpUi7qF5Ee3Af3RqPWVbq
...
| [did-kscirc]() | 0.1 | [1.0](https://tangy-gallium-b9b.notion.site/DID-Method-Specification-KSChain-7a77664f1eae47769692f4ff2d029fe0) | [k4security/kschain-resolver](https://hub.docker.com/r/k4security/kschain-resolver) | KSChain blockchain |
