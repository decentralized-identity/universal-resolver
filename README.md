...
The Universal Resolver resolves Decentralized Identifiers (DIDs) across many different DID methods, based on the [W3C DID Core 1.0 specification](https://www.w3.org/TR/did-core/).
...
| Driver Name | Driver Version | DID Method Spec Version | Docker Image |
| ----------- | -------------- | ----------------------- | ------------ |
...
| [did-stack](https://github.com/decentralized-identity/uni-resolver-driver-did-stack/) | 0.1 | (missing) | [universalresolver/driver-did-stack](https://hub.docker.com/r/universalresolver/driver-did-stack/)
...
| [did-ebsi](https://api.preprod.ebsi.eu/docs/#/DID%20Registry) | 2.0.0 | 2.0.0 | (missing) |
