...
You should then be able to resolve identifiers locally using simple `curl` requests as follows:
	...
	curl -X GET http://localhost:8080/1.0/identifiers/did:kilt:4pF5Y2Eo6doQHPLQj5AkndZwtomVB8ab2sRftRS2D9JDdELr
...
| [did-kilt](https://github.com/KILTprotocol/kilt-did-driver) | 2.1.0 | [1.0](https://github.com/KILTprotocol/kilt-did-driver/blob/master/docs/did-spec/spec.md) | [kiltprotocol/kilt-did-driver](https://hub.docker.com/r/kiltprotocol/kilt-did-driver)| KILT Protocol
