...
HZ_ID="Z07034832165V2JXMP0FS"   # Hosted Zone ID for dev.uniresolver.io (from your CLI output)
RECORD_NAME="dev.uniresolver.io."
ALB_DNS="k8s-uniresol-uniresol-01e0b1f895-139924821.us-east-2.elb.amazonaws.com"
AWS_REGION="us-east-2"          # Region of the ALB

# === derive the ALB's Canonical Hosted Zone ID (safer than hardcoding) ===
